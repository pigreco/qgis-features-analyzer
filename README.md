...
python3 extract_developers_companies.py
```
...
- `extract_developers_companies.py` analyzes the data to create a mapping of developers to their companies and saves it to `developers_companies.txt`
...
- **developers_companies.txt** - Generated by `extract_developers_companies.py` (mapping of developers to companies)
